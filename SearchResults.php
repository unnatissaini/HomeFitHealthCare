...
if($id>0 and $id<=20)
{
$conn = mysqli_connect('localhost','root', '15bce1286','');
if(!$conn)
{
...
<html>
<head>
	<title> | <?php echo strtoupper($txt);?></title>
...
<body>
	...
	<div class="medictab">
			...
			<h3> <p style="text-decoration:none;">Saving Lives | Protecting People | Sharing Knowledge</p></h3>
			
			<form action="SearchResults.php" method="GET">
				<input type="text" name="search" placeholder="Search ..." size="30" onkeyup="showHints(this.value)"/>
...
<br/><br/><br/>
	<div style="position: relative; top: 55px; z-final: -1; min-width: 30%; width: 100%;">
	...
	<div style="position: relative; top: 30px; overflow: auto; z-final:-1;">
